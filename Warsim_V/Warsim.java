...
public class Warsim {
    ...
    public static void main(String[] args) {
        ...
        // Set a random arena for the battle
        int arenaType = randNum.nextInt(3) + 1;
        ...
        System.out.println("Battle Arena: " + arena.getArenaType());
        ...
        while (!gameOver) { // while the game is NOT over
            if (playerTurn) {
                ...
                if (attackType == 3) { // Surrender option
                    ink.printSurrenderMessage();
                    winner = "Enemy";
                    gameOver = true;
                    continue; // skip to end game
                }
                damage = pWeapon.strike(weather.getSeverity(), attackType, player.getStrength(), player.getDexterity());
                damage = (int) arena.modifyDamage(damage);
    ...
    public static void createWeapon(String who, int choice) {
        switch (choice) {
            ...
            case 4: // Great Sword
                if (who.equals("Player")) {
                    pWeapon = new GreatSword();
                } else {
                    eWeapon = new GreatSword();
                }
                break;
            default:
                System.out.println("oops!");
    ...
    public static void createArena(int arenaType) {
        switch (arenaType) {
            ...
            case 3: // Plain
                ...
                break;
            default:
                System.out.println("Unknown arena type!");
                break;
        }
    } // createArena()
} // class
